...
class MyTestCase(unittest.TestCase):
    ...
    def test_addition(self):
        test_data = csvreader('csvdata/UnitTestAddition.csv').data
    ...
    def test_subtraction(self):
        test_data = csvreader('csvdata/UnitTestSubtraction.csv').data
        for row in test_data:
            result = float(row['Result'])
    ...
    def test_times(self):
        test_data = csvreader('csvdata/UnitTestMultiplication.csv').data
        for row in test_data:
            result = float(row['Result'])
    ...
    def test_div(self):
        test_data = csvreader('csvdata/UnitTestDivision.csv').data
        for row in test_data:
            result = float(row['Result'])
    ...
    def test_square(self):
        test_data = csvreader('csvdata/UnitTestSquare.csv').data
        for row in test_data:
            result = float(row['Result'])
    ...
    def test_sqrt(self):
        test_data = csvreader('csvdata/UnitTestSquareRoot.csv').data
        for row in test_data:
            result = float(row['Result'])
